...
NODECHARINS ,NODEHELPOPTN,NODEEDI2SRC1,NODEEDI2SRCN,NODEEXPLCOPY,
...
NODEDROOSMEM,NODEDROOSDC ,NODEEXPLNEWF,NODEEXPLDELF};
...
struct MNode
{
    ...
    int  iSBar;              //Menu bar linked to this item
    int iInv;                //Inverse print mode
...
void MenuSetNode(int,int,char *,int,int,int,void (*pFunc)(int,int));
void MenuClear(void);
void MenuPrintBar(int);
void MenuPrintNode(int,int);
void MenuSetBar(int);
int MenuGetBar(void);
